sap.ui.define([
	...
	function (Fragment, Controller, DateFormat, JSONModel, unifiedLibrary, MessageToast, SinglePlanningCalendarView) {
		"use strict";

		var CalendarDayType = unifiedLibrary.CalendarDayType;

		var PageController = Controller.extend("PromoCalendar.Page", {
			...
			onInit: function () {
				...
				oModel.setData({
					...
					appointments: [{
						...
						title: "Weekend Points Event",
						type: CalendarDayType.Type09,
						startDate: new Date("2018", "6", "14", "00", "00"),
						endDate: new Date("2018", "6", "15", "00", "00")
					}, {
						title: "L'Oreal Promotion",
						type: CalendarDayType.Type01,
						startDate: new Date("2018", "6", "9", "00", "00"),
						endDate: new Date("2018", "6", "14", "00", "00")
					}, {
						title: "3 for 2 on Dove",
						type: CalendarDayType.Type01,
						startDate: new Date("2018", "6", "16", "00", "00"),
						endDate: new Date("2018", "6", "22", "00", "00")
					}, {
						title: "Soltan Save 105",
						type: CalendarDayType.Type01,
						startDate: new Date("2018", "6", "11", "00", "00"),
						endDate: new Date("2018", "6", "18", "00", "00")
					}, {
				...
				this._createFortnightCustomViewClass();
				...
				var oSPC = this.getView().byId("SPC1"),
					...
					oMyCustomFortnightView = new sap.custom.CustomFortnightView({
						key: "14Days",
						title: "14 Days"
					});
				oSPC.addView(oMyCustomFortnightView);
				oSPC.addView(oWeekView);
				oSPC.addView(oDayView);

			},

			_createFortnightCustomViewClass: function () {
				SinglePlanningCalendarView.extend("sap.custom.CustomFortnightView");

				sap.custom.CustomFortnightView.prototype.getEntityCount = function () {
					return 14;
				};

				sap.custom.CustomFortnightView.prototype.getScrollEntityCount = function () {
					return 14;
				};

				sap.custom.CustomFortnightView.prototype.calculateStartDate = function (oStartDate) {
					return oStartDate;
				};
			...
			handleAppointmentSelect: function (oEvent) {
				...
				if (!this._oDetailsPopover) {
					Fragment.load({
							id: "popoverFrag",
							name: "PromoCalendar.view.Details",
							controller: this
						})
			...
			_arrangeDialogFragment: function (sTitle) {
				if (!this._oNewAppointmentDialog) {
					Fragment.load({
							id: "dialogFrag",
							name: "PromoCalendar.view.Modify",
							controller: this
						})
